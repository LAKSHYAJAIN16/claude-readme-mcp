...
1. Decide which style to write in:
   ...
   - If the user just states a style preference directly (e.g. "always include a screenshots section", "use emoji in headings"), call `set_readme_style` with that instead of guessing.
...
4. Write the draft, following whichever style guide was resolved in step 1.
